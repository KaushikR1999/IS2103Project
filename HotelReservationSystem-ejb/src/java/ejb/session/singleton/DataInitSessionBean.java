...
//        private final SimpleDateFormat formatDate = new SimpleDateFormat("yyyy-MM-dd");
        ...
        Date endDateC = new Date(2021, 10, 15);
        Date startDateD = new Date(2021,11,11);
        Date endDateD = new Date(2021, 9, 15);
        Date startDateE = new Date(2021,10,11);
        Date endDateE = new Date(2021, 11, 15);
        Date startDateF = new Date(2021,11,11);
        Date endDateF = new Date(2021, 11, 15);
        Date startDateG = new Date(2021,11,11);
        Date endDateG = new Date(2021, 11, 15);
        Date startDateH = new Date(2021,11,11);
        Date endDateH = new Date(2021, 11, 15);
        Date startDateI = new Date(2021,11,11);
        Date endDateI = new Date(2021, 11, 15);
        Date startDateJ = new Date(2021,11,11);
        Date endDateJ = new Date(2021, 11, 15);
